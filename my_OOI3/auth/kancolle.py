...
class KancolleAuth:
    ...
    world_ip_list = (
        ...
        "125.6.187.205",	# 舞鶴鎮守府
        "125.6.187.229",	# 大湊警備府
        "125.6.187.253",	# トラック泊地(Truk)
        "125.6.188.25",		# リンガ泊地(Lingga)
        "203.104.248.135",	# ラバウル基地(Rabaul)
        "125.6.189.7",		# ショートランド泊地(Shortland)
        "125.6.189.39",		# ブイン基地(Buin)
        "125.6.189.71",		# タウイタウイ泊地(Tawi-Tawi)
        "125.6.189.103",	# パラオ泊地(Palau)
        "125.6.189.135",	# ブルネイ泊地(Brunei)
        "125.6.189.167",	# 単冠湾泊地
        "125.6.189.215",	# 幌筵泊地
        "125.6.189.247",	# 宿毛湾泊地
        "203.104.209.23",	# 鹿屋基地
    ...
    def _get_osapi_url(self):
        ...
        if m:
            raise OOIAuthException('Change Password Please')
